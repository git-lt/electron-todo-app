...
const renderer = {
  code(code: string, infostring: string, escaped) {
    ...
    return `<div class="bg-black mb-4 rounded-md">
      <div class="code_header flex items-center relative text-gray-200 bg-gray-800 px-4 py-2 text-sm font-sans">
        <span>${infostring || ''}</span>
        <button onclick="__hlsCopy(this)" class="flex ml-auto gap-2">
